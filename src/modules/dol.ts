...
export const tools: Tool<any, any>[] = [
  {
    ...
    parameters: z.object({
      ...
      insp_type: z.string().optional().describe("Inspection type: 'A' (accident), 'B' (complaint), 'H' (planned), 'L' (high-hazard)"),
      sort_by: z.string().optional().describe("Field to sort by: 'open_date' (default), 'close_case_date'"),
      sort_order: z.string().optional().describe("Sort direction: 'desc' (default) or 'asc'"),
...

  {
    ...
    parameters: z.object({
      ...
      viol_type: z.string().optional().describe("Violation type: 'S' (Serious), 'W' (Willful), 'R' (Repeat), 'O' (Other)"),
...

  {
    ...
    parameters: z.object({
      ...
      sort_order: z.string().optional().describe("Sort direction: 'desc' (default, newest first) or 'asc'"),
    }),
    execute: async (args) => {
